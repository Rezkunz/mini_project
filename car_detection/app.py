...
def load_models():
    ...
    # Perbaikan Wajib: Gunakan Absolute Path agar model selalu ditemukan baik di Lokal maupun Streamlit Cloud
    ...
    def process_frame_tracking(frame, is_video=True):
        ...
        for box in p_results[0].boxes:
            ...
            if plate_crop.size > 0:
                # Bypass fungsi enhance_plate yang membuat noise/halusinasi
